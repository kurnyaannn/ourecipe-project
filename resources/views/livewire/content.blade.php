<div>
    ...
    <div class="bg-white shadow-md">
        <div class="px-4 py-3 sm:px-8 md:px-16">
            <div class="flex items-center justify-center text-teal-700 text-xl font-semibold font-lora mb-2">What kind of dish you're looking for ?</div>
            ...
            <div class="flex justify-around items-center">
                <a href="{{ route('store-recipe') }}" class="bg-teal-500 px-4 py-2 rounded-md hover:bg-teal-400 shadow-md transform hover:scale-105 transition ease-out duration-300 font-nunito font-semibold text-white text-center">Create Your Own</a>
            </div>
        </div>
    </div>
    <div class="px-4 py-3 mb-3 sm:px-8 md:px-16">
        <div class="flex items-center text-teal-700 text-xl font-semibold font-lora mb-1 py-2">Recipes Lists</div>
